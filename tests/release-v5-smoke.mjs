...
const notes = fs.readFileSync(new URL('../RELEASE_NOTES_v5.11.15.md', import.meta.url), 'utf8');
...
assert.match(indexHtml, /const APP_VERSION = '5\.11\.15';/);
...
assert.match(indexHtml, /collaboration-core-v5\.js\?v=5\.11\.15/);
assert.match(indexHtml, /live-collaboration-v5\.js\?v=5\.11\.15/);
assert.match(indexHtml, /app-v5\.js\?v=5\.11\.15/);
assert.match(indexHtml, /timeline-core-v5\.js\?v=5\.11\.15/);
...
assert.match(scannerHtml, /processing\/lightweight\.js\?v=5\.11\.15/);
...
console.log('v5.11.15 smoke checks passed.');
